...
<div class="container mt-4">
    ...
    <a href="{{ route('thesis_defenses.create') }}" class="btn btn-primary mb-3">+ Tambah Thesis Defense</a>
        ...
        <tbody>
            @forelse ($defenses as $defense)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('thesis_defenses.edit', $defense->id) }}" class="btn btn-sm btn-warning">Edit</a>
                    </td>
                </tr>
            @empty
                <tr>
