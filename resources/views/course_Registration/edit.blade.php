        ...
        <div class="card-body bg-light">
            <form 
                action="{{ isset($courseRegistration) 
                    ? route('course_registration.update', $courseRegistration->id) 
                    : route('course_registration.store') }}" 
                method="POST"
            >
                @csrf
                ...
                <div class="d-flex justify-content-between mt-4">
                    <a href="{{ route('course_registration.index') }}" class="btn btn-outline-success px-4 rounded-3">
                        ← Kembali
                    </a>
