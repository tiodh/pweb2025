...
<div class="container py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('thesis-examiner.create') }}" class="btn btn-primary">Add Examiner</a>
    </div>
                ...
                @forelse($te as $index => $examiner)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('thesis-examiner.edit', $examiner->id) }}"
                               class="btn btn-sm btn-outline-secondary">
                                Edit
                            </a>

                            <form action="{{ route('thesis-examiner.destroy', $examiner->id) }}"
                                  method="POST"
                                  class="d-inline"
