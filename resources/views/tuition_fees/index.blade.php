...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            {{-- Tombol Tambah --}}
<<<<<<< HEAD
            <a href="{{ route('tuition-fees.create') }}" class="btn btn-primary mb-3">
=======
            <a href="{{ route('tuition-fee.create') }}" class="btn btn-primary mb-3">
>>>>>>> 6bdfb20a811c0c6806f3b52841934657b7a5012f
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- Tombol Edit --}}
<<<<<<< HEAD
                            <a href="{{ route('tuition-fees.edit', $fee->id) }}" class="btn btn-sm btn-warning">Edit</a>
                            
                            {{-- Tombol Delete --}}
                            <form action="{{ route('tuition-fees.destroy', $fee->id) }}" method="POST" class="d-inline">
=======
