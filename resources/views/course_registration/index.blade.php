...
<div class="container mt-4">
    ...
    <div class="text-end mb-3">
        <a href="{{ route('course-registration.create') }}" class="btn btn-success">+ Tambah KRS</a>
    </div>
                ...
                <tbody>
                    @forelse ($courseRegistrations as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('course-registration.edit', $item->id) }}" 
                                   class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('course-registration.destroy', $item->id) }}" 
