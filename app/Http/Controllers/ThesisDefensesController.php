...
class ThesisDefensesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('thesis-defenses.index')->with('success', 'Data defense berhasil ditambahkan');
    }
    ...
    public function update(Request $request, thesis_defenses $thesis_defenses)
    {
        ...
        return redirect()->route('thesis-defenses.index')->with('success', 'Data defense berhasil diperbarui');
    }
    ...
    public function destroy(thesis_defenses $thesis_defenses)
    {
        ...
        return redirect()->route('thesis-defenses.index')->with('success', 'Data defense berhasil dihapus!');
    }
}